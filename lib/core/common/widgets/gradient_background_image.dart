...
/// The `GradientBackgroundImage` widget is used to create a visually appealing
...
class GradientBackgroundImage extends StatelessWidget {
  /// Create a `GradientBackgroundImage` with the specified `child` and `image`.
  ///
